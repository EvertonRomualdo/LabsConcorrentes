...
public class ImageMeanFilter {
     ...
     */
    public static void applyMeanFilter(String inputPath, String outputPath, int kernelSize, int n) throws IOException, InterruptedException {
        // Load image
        ...
        Semaphore multiplex = new Semaphore(n);
        List<Thread> threadsList = new LinkedList<Thread>();
        for (int y = 0; y < height; y++) {

            multiplex.acquire();
            Runnable runnable = new execLoop(originalImage, filteredImage, kernelSize, y, width, mutex, multiplex);
    ...
    public static class execLoop implements Runnable{
        //originalImage, x, y, kernelSize
        ...
        public execLoop(BufferedImage originalImage, BufferedImage filteredImage, int kernelSize, int y, int width, Semaphore mutex, Semaphore multiplex) {
